...
if (NOT TARGET Qt5::Multimedia)
    ...
    _populate_Multimedia_target_properties(DEBUG "Qt5Multimediad.lib" "" )

    if (EXISTS "${_qt5Multimedia_install_prefix}/lib/Qt5Multimedia.lib" )
        _populate_Multimedia_target_properties(RELEASE "Qt5Multimedia.lib" "" )
    endif()
