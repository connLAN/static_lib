...
if (NOT TARGET Qt5::MultimediaWidgets)
    ...
    _populate_MultimediaWidgets_target_properties(DEBUG "Qt5MultimediaWidgetsd.lib" "" )

    if (EXISTS "${_qt5MultimediaWidgets_install_prefix}/lib/Qt5MultimediaWidgets.lib" )
        _populate_MultimediaWidgets_target_properties(RELEASE "Qt5MultimediaWidgets.lib" "" )
    endif()
