...
if (NOT TARGET Qt5::DBus)
    ...
    _populate_DBus_target_properties(DEBUG "Qt5DBusd.lib" "" )

    if (EXISTS "${_qt5DBus_install_prefix}/lib/Qt5DBus.lib" )
        _populate_DBus_target_properties(RELEASE "Qt5DBus.lib" "" )
    endif()
