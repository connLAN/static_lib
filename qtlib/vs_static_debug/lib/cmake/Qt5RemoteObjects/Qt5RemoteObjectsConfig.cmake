...
if (NOT TARGET Qt5::RemoteObjects)
    ...
    _populate_RemoteObjects_target_properties(DEBUG "Qt5RemoteObjectsd.lib" "" )

    if (EXISTS "${_qt5RemoteObjects_install_prefix}/lib/Qt5RemoteObjects.lib" )
        _populate_RemoteObjects_target_properties(RELEASE "Qt5RemoteObjects.lib" "" )
    endif()
