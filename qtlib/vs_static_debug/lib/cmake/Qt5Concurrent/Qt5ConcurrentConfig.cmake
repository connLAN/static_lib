...
if (NOT TARGET Qt5::Concurrent)
    ...
    _populate_Concurrent_target_properties(DEBUG "Qt5Concurrentd.lib" "" )

    if (EXISTS "${_qt5Concurrent_install_prefix}/lib/Qt5Concurrent.lib" )
        _populate_Concurrent_target_properties(RELEASE "Qt5Concurrent.lib" "" )
    endif()
