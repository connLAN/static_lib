...
if (NOT TARGET Qt5::WebView)
    ...
    _populate_WebView_target_properties(RELEASE "Qt5WebView.lib" "" )

    if (EXISTS "${_qt5WebView_install_prefix}/lib/Qt5WebViewd.lib" )
        _populate_WebView_target_properties(DEBUG "Qt5WebViewd.lib" "" )
    endif()
