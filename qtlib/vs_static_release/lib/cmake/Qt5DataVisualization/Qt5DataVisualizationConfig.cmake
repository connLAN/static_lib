...
set(Qt5DataVisualization_VERSION_STRING 5.12.2)
...
if (NOT TARGET Qt5::DataVisualization)
    ...
    set(Qt5DataVisualization_PRIVATE_INCLUDE_DIRS
        "${_qt5DataVisualization_install_prefix}/include/QtDataVisualization/5.12.2"
        "${_qt5DataVisualization_install_prefix}/include/QtDataVisualization/5.12.2/QtDataVisualization"
    )
    ...
    foreach(_module_dep ${_Qt5DataVisualization_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.12.2 ${_Qt5DataVisualization_FIND_VERSION_EXACT}
    ...
    add_library(Qt5::DataVisualization STATIC IMPORTED)
    set_property(TARGET Qt5::DataVisualization PROPERTY IMPORTED_LINK_INTERFACE_LANGUAGES CXX)
    ...
    _populate_DataVisualization_target_properties(RELEASE "Qt5DataVisualization.lib" "" )

    if (EXISTS "${_qt5DataVisualization_install_prefix}/lib/Qt5DataVisualizationd.lib" )
        _populate_DataVisualization_target_properties(DEBUG "Qt5DataVisualizationd.lib" "" )
    endif()
