...
if (NOT TARGET Qt5::Scxml)
    ...
    _populate_Scxml_target_properties(RELEASE "Qt5Scxml.lib" "" )

    if (EXISTS "${_qt5Scxml_install_prefix}/lib/Qt5Scxmld.lib" )
        _populate_Scxml_target_properties(DEBUG "Qt5Scxmld.lib" "" )
    endif()
