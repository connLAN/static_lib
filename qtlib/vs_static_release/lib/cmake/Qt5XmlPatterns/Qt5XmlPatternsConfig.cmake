...
if (NOT TARGET Qt5::XmlPatterns)
    ...
    _populate_XmlPatterns_target_properties(RELEASE "Qt5XmlPatterns.lib" "" )

    if (EXISTS "${_qt5XmlPatterns_install_prefix}/lib/Qt5XmlPatternsd.lib" )
        _populate_XmlPatterns_target_properties(DEBUG "Qt5XmlPatternsd.lib" "" )
    endif()
