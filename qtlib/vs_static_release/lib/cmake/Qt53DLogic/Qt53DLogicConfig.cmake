...
if (NOT TARGET Qt5::3DLogic)
    ...
    _populate_3DLogic_target_properties(RELEASE "Qt53DLogic.lib" "" )

    if (EXISTS "${_qt53DLogic_install_prefix}/lib/Qt53DLogicd.lib" )
        _populate_3DLogic_target_properties(DEBUG "Qt53DLogicd.lib" "" )
    endif()
