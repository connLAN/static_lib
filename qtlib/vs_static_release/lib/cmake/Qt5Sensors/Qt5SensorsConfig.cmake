...
if (NOT TARGET Qt5::Sensors)
    ...
    _populate_Sensors_target_properties(RELEASE "Qt5Sensors.lib" "" )

    if (EXISTS "${_qt5Sensors_install_prefix}/lib/Qt5Sensorsd.lib" )
        _populate_Sensors_target_properties(DEBUG "Qt5Sensorsd.lib" "" )
    endif()
