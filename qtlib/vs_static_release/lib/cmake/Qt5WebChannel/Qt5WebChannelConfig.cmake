...
if (NOT TARGET Qt5::WebChannel)
    ...
    _populate_WebChannel_target_properties(RELEASE "Qt5WebChannel.lib" "" )

    if (EXISTS "${_qt5WebChannel_install_prefix}/lib/Qt5WebChanneld.lib" )
        _populate_WebChannel_target_properties(DEBUG "Qt5WebChanneld.lib" "" )
    endif()
