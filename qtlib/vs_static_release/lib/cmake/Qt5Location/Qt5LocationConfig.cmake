...
if (NOT TARGET Qt5::Location)
    ...
    _populate_Location_target_properties(RELEASE "Qt5Location.lib" "" )

    if (EXISTS "${_qt5Location_install_prefix}/lib/Qt5Locationd.lib" )
        _populate_Location_target_properties(DEBUG "Qt5Locationd.lib" "" )
    endif()
