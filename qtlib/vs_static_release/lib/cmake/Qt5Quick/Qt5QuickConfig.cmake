...
if (NOT TARGET Qt5::Quick)
    ...
    _populate_Quick_target_properties(RELEASE "Qt5Quick.lib" "" )

    if (EXISTS "${_qt5Quick_install_prefix}/lib/Qt5Quickd.lib" )
        _populate_Quick_target_properties(DEBUG "Qt5Quickd.lib" "" )
    endif()
