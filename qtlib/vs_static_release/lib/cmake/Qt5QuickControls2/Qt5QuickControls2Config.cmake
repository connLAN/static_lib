...
if (NOT TARGET Qt5::QuickControls2)
    ...
    _populate_QuickControls2_target_properties(RELEASE "Qt5QuickControls2.lib" "" )

    if (EXISTS "${_qt5QuickControls2_install_prefix}/lib/Qt5QuickControls2d.lib" )
        _populate_QuickControls2_target_properties(DEBUG "Qt5QuickControls2d.lib" "" )
    endif()
