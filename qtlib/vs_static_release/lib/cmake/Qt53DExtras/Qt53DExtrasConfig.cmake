...
if (NOT TARGET Qt5::3DExtras)
    ...
    _populate_3DExtras_target_properties(RELEASE "Qt53DExtras.lib" "" )

    if (EXISTS "${_qt53DExtras_install_prefix}/lib/Qt53DExtrasd.lib" )
        _populate_3DExtras_target_properties(DEBUG "Qt53DExtrasd.lib" "" )
    endif()
