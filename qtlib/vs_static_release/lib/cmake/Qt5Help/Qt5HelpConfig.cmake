...
if (NOT TARGET Qt5::Help)
    ...
    _populate_Help_target_properties(RELEASE "Qt5Help.lib" "" )

    if (EXISTS "${_qt5Help_install_prefix}/lib/Qt5Helpd.lib" )
        _populate_Help_target_properties(DEBUG "Qt5Helpd.lib" "" )
    endif()
