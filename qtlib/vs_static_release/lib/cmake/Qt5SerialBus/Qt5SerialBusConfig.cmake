...
if (NOT TARGET Qt5::SerialBus)
    ...
    _populate_SerialBus_target_properties(RELEASE "Qt5SerialBus.lib" "" )

    if (EXISTS "${_qt5SerialBus_install_prefix}/lib/Qt5SerialBusd.lib" )
        _populate_SerialBus_target_properties(DEBUG "Qt5SerialBusd.lib" "" )
    endif()
