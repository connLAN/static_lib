...
if (NOT TARGET Qt5::Bluetooth)
    ...
    _populate_Bluetooth_target_properties(RELEASE "Qt5Bluetooth.lib" "" )

    if (EXISTS "${_qt5Bluetooth_install_prefix}/lib/Qt5Bluetoothd.lib" )
        _populate_Bluetooth_target_properties(DEBUG "Qt5Bluetoothd.lib" "" )
    endif()
