...
if (NOT TARGET Qt5::TextToSpeech)
    ...
    _populate_TextToSpeech_target_properties(RELEASE "Qt5TextToSpeech.lib" "" )

    if (EXISTS "${_qt5TextToSpeech_install_prefix}/lib/Qt5TextToSpeechd.lib" )
        _populate_TextToSpeech_target_properties(DEBUG "Qt5TextToSpeechd.lib" "" )
    endif()
